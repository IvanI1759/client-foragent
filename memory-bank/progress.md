...
- [x] `src/bot/handlers/message.js` — роутинг текста → агент, `/reset`, `/new`, лимит 4000 символов, история ограничена последними 10 записями из `sessions`, user rate limit (20/час), уведомление owner при 80% глобального лимита.
